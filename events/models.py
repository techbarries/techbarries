...
class Event(TrackingModel):
    ...
    coverPhoto=models.ImageField(upload_to="event_cover/%Y/%m/%d/",blank=True)
    ...
    university_campus=models.ForeignKey(to=University,on_delete=models.CASCADE,related_name="university_campus")
    venue=models.ForeignKey(to=Venue,on_delete=models.CASCADE,related_name="event_venue_name")
